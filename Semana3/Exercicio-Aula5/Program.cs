...
// Console.WriteLine("--- Tuple Exemples ---\n");
...
// Console.WriteLine("\n--- LambdaExpression Exemples --- \n");

// string[] people = { "Alberto", "Everaldina", "João", "Maria", "José" };
// char letter = 'A';
// char letter2 = 'a';
// Console.WriteLine($"People that the name contains '{letter}': {string.Join(", ", people.Where(x => x.Contains(letter) || x.Contains(letter2)))}");
